    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <header className="fixed w-full z-50 bg-tpp-dark/95 backdrop-blur border-b border-slate-800 text-white">
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden absolute top-20 left-0 w-full bg-tpp-dark border-b border-slate-800 p-4 flex flex-col gap-4 shadow-2xl">
            ...
            <Link to="/services" className="text-lg py-2 hover:text-tpp-primary font-semibold">Услуги</Link>
            <Link to="/news" className="text-lg py-2 hover:text-tpp-primary font-semibold">Новости</Link>
      ...
      <footer className="bg-tpp-dark text-slate-400 py-12 border-t border-slate-800">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-sm">© 2025 ZTPP v6. Cyber-Industrial Edition.</p>
        </div>
      </footer>
    </div>
  );
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-tpp-dark text-white shadow-2xl relative overflow-hidden transform md:-translate-y-4 border border-slate-700">
