...
import { 
  ...
  MessageCircle, LayoutGrid, LifeBuoy, // ✅ Новая иконка (Спасательный круг)
  ...
  const allCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { id: "dev-ip", name: "Регистрация товарных знаков", desc: "Проверка бренда на уникальность, подача заявки в Роспатент, полное сопровождение регистрации бренда. Защита интеллектуальной собственности." },
        { id: "dev-eco", name: "Экологическое проектирование", desc: "Разработка паспортов отходов, проектов ПДВ, сдача экологической отчетности для предприятий." },
        { id: "dev-sout", name: "Специальная оценка условий труда (СОУТ)", desc: "Организация проведения спецоценки рабочих мест в соответствии с требованиями трудового законодательства. Помощь в оформлении деклараций." },
    ...
    // 8-й БЛОК: Заполнитель
    {
      ...
      icon: LifeBuoy, // ✅ Иконка Спасательный круг
      color: "bg-blue-50 text-blue-600", // ✅ Синий стиль
      isAction: true,
      services: [] 
    }
  ];
           ...
           <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {allCategories.map((cat, idx) => (
                ...
                >
                    ...
                    {/* 8-й БЛОК: Иконка LifeBuoy + Синий цвет */}
                    {cat.isAction && (
                       <>
            ...
            <div key={catIdx} id={cat.id} className="scroll-mt-32">
              ...
              <div className="grid gap-6">
                {cat.services.map((service) => (
                  <div key={service.id} id={service.id} className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 hover:shadow-md transition-shadow scroll-mt-48">
