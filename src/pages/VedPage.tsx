...
export const VedPage: React.FC = () => {
  ...
  const [selectedService, setSelectedService] = useState<string>('Поиск партнера в Китае');
  ...
  const services = [
    {
      id: 'search',
      title: 'Поиск партнера в Китае',
      shortDesc: 'Подбор надежных поставщиков и производителей в КНР по вашему техническому заданию.',
      longDesc: 'Мы проводим глубокий поиск производителей в Китае, минуя посредников. Проверяем фабрики на реальность существования, запрашиваем учредительные документы и образцы продукции. Вы получаете отчет с контактами проверенных поставщиков, готовых к сотрудничеству с Россией.',
      icon: Search
    },
    {
      id: 'verification',
      title: 'Проверка контрагента',
      shortDesc: 'Аудит китайских компаний: проверка регистрации, репутации и судебной истории.',
      longDesc: 'Проверка благонадежности китайского партнера по официальным реестрам КНР (AIC). Узнаем уставной капитал, законных представителей, наличие судебных исков и экспортной лицензии. Это критически важно перед отправкой предоплаты.',
      icon: CheckCircle2
    },
    {
      id: 'missions',
      title: 'Бизнес-миссии',
      shortDesc: 'Организация деловых поездок в Китай, посещение выставок и переговоры.',
      longDesc: 'Организуем участие в Кантонской ярмарке, выставках в Харбине, Пекине и Шанхае. Берем на себя визовую поддержку, трансфер, услуги переводчиков и организацию B2B-встреч с целевыми партнерами.',
      icon: Plane
    },
    {
      id: 'translation',
      title: 'Переводы и переговоры',
      shortDesc: 'Устный и письменный перевод с китайского языка. Сопровождение сделок.',
      longDesc: 'Профессиональный перевод контрактов, технической документации и инвойсов. Предоставляем переводчиков для онлайн-переговоров (WeChat, Zoom) и личных встреч. Помогаем преодолеть культурный барьер и правильно донести условия сделки.',
      icon: Languages
    },
    {
      id: 'contract',
      title: 'Экспертиза контракта',
      shortDesc: 'Проверка внешнеторгового контракта на соответствие валютному и таможенному законодательству.',
      longDesc: 'Юридический анализ контракта с китайским поставщиком. Проверяем условия поставки (Инкотермс), порядок расчетов, ответственность сторон и арбитражную оговорку, чтобы защитить ваши интересы в случае спора.',
      icon: FileText
    },
    {
      id: 'disputes',
      title: 'Разрешение споров',
      shortDesc: 'Медиация и юридическая помощь при возникновении конфликтов с китайскими партнерами.',
      longDesc: 'Содействие в досудебном урегулировании споров. Подготовка претензионных писем на китайском языке. Консультации по обращению в Китайскую международную экономическую и торговую арбитражную комиссию (CIETAC).',
      icon: Handshake
    },
  ];
  ...
  const faqs = [
    {
      question: "Как проверить, что китайский завод реальный, а не мошенники?",
      answer: "Необходимо запросить бизнес-лицензию (Business License) и проверить её в реестре. Мы также рекомендуем заказать выездную инспекцию или видео-аудит производства через наших партнеров."
    },
    {
      question: "Помогаете ли вы с оплатой в Китай в условиях санкций?",
      answer: "Мы консультируем по актуальным маршрутам платежей и банкам, которые продолжают работать с КНР. Ситуация меняется быстро, поэтому мы даем рекомендации на момент обращения."
    },
    {
      question: "Нужна ли виза для посещения выставок в Маньчжурии?",
      answer: "Для посещения приграничных зон часто действуют упрощенные режимы, но для поездок вглубь страны нужна виза. Мы оказываем визовую поддержку членам официальных делегаций Палаты."
    }
  ];
  ...
  return (
    <div className="font-sans text-slate-900 bg-white">
      <SEO 
        title="ВЭД с Китаем: Поиск партнеров, Проверка контрагентов | ТПП Забайкальского края"
        description="Услуги ВЭД под ключ: поиск поставщиков в Китае, проверка надежности, переводы контрактов, организация бизнес-миссий. Помощь экспортерам и импортерам."
            ...
            <div className="grid lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7 max-w-3xl">
                ...
                <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl">
                  Поиск поставщиков, проверка надежности, сопровождение контрактов и организация бизнес-миссий. Используйте наше приграничное положение для вашего бизнеса.
                </p>
              ...
              <div className="hidden lg:flex lg:col-span-5 justify-center items-center relative">
                ...
                <div className="relative transform transition-transform duration-500 hover:scale-105">
                   <Globe size={300} strokeWidth={1} className="text-slate-600/70 drop-shadow-2xl" />
                   <Globe size={300} strokeWidth={1} className="absolute top-0 left-0 text-white/10" />
                </div>
              </div>
            </div>
        </div>
      ...
      <section className="pt-12 pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <h2 className="text-3xl font-extrabold text-slate-900 mb-12 text-center">Комплексное сопровождение ВЭД</h2>
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-200">
        <div className="max-w-4xl mx-auto px-6 md:px-8">
          <h2 className="text-3xl font-extrabold text-slate-900 mb-8 text-center">Детально об услугах</h2>
        ...
        <section className="py-20 bg-slate-900 text-white">
          <div className="max-w-5xl mx-auto px-6 md:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-start">
              <div>
                <h2 className="text-3xl md:text-4xl font-extrabold mb-6">Начните работу с Китаем правильно</h2>
                <p className="text-slate-300 text-lg mb-8">
                  Заполните форму, и наши специалисты свяжутся с вами для обсуждения деталей вашего проекта.
                </p>
                <div className="pt-8 border-t border-slate-700">
                  <p className="text-slate-400 text-sm mb-3 font-medium uppercase tracking-wider">Контакты отдела ВЭД</p>
