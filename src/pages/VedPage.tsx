  ...
  const services = [
    {
      ...
      longDesc: 'Мы проводим глубокий поиск производителей в Китае, минуя посредников. Проверяем фабрики на реальность существования, запрашиваем учредительные документы и образцы продукции. Вы получают отчет с контактами проверенных поставщиков, готовых к сотрудничеству с Россией.',
      icon: Search
    },
    {
      id: 'verification',
