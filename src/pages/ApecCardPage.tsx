...
const ApecCardPage: React.FC = () => {
  ...
  const countryData = [
    { name: "Китай (КНР)", days: "60 дней", spec: "Основные интересы для бизнеса: Направление №1 для Забайкалья. Карта заменяет годовые бизнес-визы, экономя бюджет и время.", icon: Building },
    { name: "Австралия", days: "90 дней", spec: "Основные интересы для бизнеса: Высокий интерес со стороны горнодобывающего сектора. Карта открывает въезд в одну из самых сложных для виз стран.", icon: HardHat },
    { name: "Южная Корея", days: "90 дней", spec: "Основные интересы для бизнеса: Импорт спецтехники, оборудования, автомобилей. Второй по значимости партнер региона.", icon: Briefcase },
    { name: "Япония", days: "60 дней", spec: "Основные интересы для бизнеса: Импорт технологий и оборудования. Карта снимает требование о наличии обязательного гаранта в Японии.", icon: Microscope },
    { name: "Мексика", days: "90 дней", spec: "Основные интересы для бизнеса: Прямой доступ к рынкам Северной Америки и латиноамериканским партнерам.", icon: Plane },
    { name: "Чили", days: "90 дней", spec: "Основные интересы для бизнеса: Горнодобывающая промышленность, сельское хозяйство и экспорт ресурсов.", icon: HardHat },
    { name: "Перу", days: "90 дней", spec: "Основные интересы для бизнеса: Сотрудничество в сфере добычи полезных ископаемых и обмена опытом.", icon: Building },
    { name: "Вьетнам", days: "60 дней", spec: "Основные интересы для бизнеса: Важный торговый партнер. Карта дает 2 месяца для полноценных переговоров и инспекций заводов.", icon: Handshake },
    { name: "Сингапур", days: "60 дней", spec: "Основные интересы для бизнеса: Крупнейший финансовый и логистический хаб. Карта дает безусловный приоритет в аэропорту.", icon: Globe },
    { name: "Новая Зеландия", days: "90 дней", spec: "Основные интересы для бизнеса: Высокие агропромышленные технологии, животноводство и экологические проекты.", icon: Sprout },
    { name: "Тайвань", days: "90 дней", spec: "Основные интересы для бизнеса: Импорт микроэлектроники и высокотехнологичного оборудования.", icon: Zap },
    { name: "Таиланд", days: "90 дней", spec: "Основные интересы для бизнеса: Легкая промышленность, экспорт продовольствия и агробизнес.", icon: Sprout }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Карта привязана к номеру паспорта. При получении нового документа карту необходимо перевыпускать. Рекомендуем оформлять ее на паспорт со сроком действия не менее 5 лет."
    }
  ];
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">Почему это нужно бизнесу?</h2>
             ...
             <div className="lg:w-1/2 space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">Карта выдается собственникам бизнеса, индивидуальным предпринимателям или сотрудникам компаний, вовлеченных в ВЭД.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center shrink-0 text-blue-600">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-slate-300 text-lg mb-8 leading-relaxed">
                Оставьте ваши контакты, и мы проведем предварительный аудит вашей деятельности на соответствие критериям АТЭС. Работаем со всеми регионами РФ.
              </p>
