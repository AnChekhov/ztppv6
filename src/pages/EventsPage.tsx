...
export const EventsPage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      longDesc: 'Комфортабельное деловое пространство для проведения конфиденциальных встреч, медиаций и приватных переговоров. Помещение обеспечивает полную тишину и рабочую атмосферу в центре города. Зал укомплектован эргономичной мебелью и высокоскоростным Wi-Fi. Это оптимальное решение, если вам требуется статусная площадка для переговоров в Чите с возможностью организации кофе-брейков.',
      icon: Coffee
    },
    {
      id: 'seminars',
