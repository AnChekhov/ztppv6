...
export const EventsPage: React.FC = () => {
  ...
  const services = [
    {
      id: 'hall',
      title: 'Конференц-зал в центре',
      shortDesc: 'Площадка для проведения обучающих семинаров, тренингов, презентаций и форумов в Чите.',
      longDesc: 'Профессиональное предоставление конференц-зала для мероприятий любого масштаба. Помещение идеально подходит для проведения форумов, обучающих курсов, пресс-конференций и презентаций продукции. Площадка полностью укомплектована мультимедийной техникой: большой экран, проектор высокой четкости, акустическая система с микрофонами и оборудование для видеоконференцсвязи (ВКС). Центр города и статусность Торгово-промышленной палаты подчеркнут уровень вашего события.',
      icon: Presentation
    },
    {
      id: 'meeting-room',
    ...
    },
    {
      ...
      shortDesc: 'Организация семинаров и мастер-классов под ключ от ведущих экспертов по ВЭД и праву.',
      longDesc: 'Проведение тренингов для персонала и руководителей. Мы привлекаем профильных специалистов федерального уровня для разбора изменений в законодательстве, налоговых правил и таможенных процедур. Организуем все этапы: от формирования программы до регистрации участников.',
      icon: BookOpen
    },
    {
      id: 'missions',
    ...
    },
    {
      ...
      shortDesc: 'Подготовка масштабных отраслевых событий, форумов и съездов в Забайкальском крае.',
      longDesc: 'Комплексная организация деловых мероприятий: подбор спикеров, техническое оснащение, взаимодействие со СМИ и GR-поддержка. Мы создаем площадки для прямого диалога бизнеса, власти и международных партнеров.',
      icon: TrendingUp
    },
    {
      id: 'networking',
      title: 'Деловой нетворкинг',
      shortDesc: 'Тематические встречи предпринимателей и неформальное общение в бизнес-сообществе.',
      longDesc: 'Формат бизнес-завтраков и закрытых встреч для членов ТПП. Обмен опытом, поиск надежных партнеров и выстраивание прямых коммуникаций с представителями региональных министерств и ведомств.',
      icon: Handshake
    },
  ];
