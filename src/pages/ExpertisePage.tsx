...
export const CertificationPage: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Да, мы являемся уполномоченным органом системы ТПП РФ. Благодаря электронному документообороту и статусу приграничной палаты, мы оформляем сертификаты для экспортеров и импортеров со всей России."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="mt-12 max-w-4xl mx-auto text-left">
            <p className="text-sm text-slate-400 leading-relaxed">
              ...
              Стоимость и сроки регламентированы Приказами ТПП РФ №14. Итоговая цена зависит от количества позиций в партии и сложности определения критериев достаточной переработки. Работаем по всей России.
            </p>
          </div>
        </div>
      </section>
