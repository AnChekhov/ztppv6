...
import { Button } from './ui/Button'; // Убедись, что этот компонент существует
  ...
  return (
    <section className="relative bg-slate-900 text-white min-h-[65vh] flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center flex flex-col items-center">
        ...
        {/* Headline - Тот самый текст, который мы нашли */}
        ...
        {/* Description - Тот самый текст, который мы нашли */}
